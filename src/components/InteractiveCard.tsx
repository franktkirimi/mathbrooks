    ...
    >
      ...
      <div
        ...
        style={{
          ...
          background: `radial-gradient(450px circle at ${spot.x}px ${spot.y}px, hsl(var(--primary) / 0.055), transparent 60%)`,
        }}
      />
      {/* Edge glow */}
      <div
        ...
        style={{
          opacity: hovering ? 1 : 0,
          boxShadow: "inset 0 0 0 1px hsl(var(--primary) / 0.12), 0 0 36px hsl(var(--primary) / 0.07)",
        }}
      />
