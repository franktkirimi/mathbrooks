  ...
  return (
    <>
      <figure className="relative min-h-[680px] overflow-hidden rounded-[2.5rem] bg-[#101211] shadow-[0_32px_80px_hsl(var(--foreground)/0.14)] lg:min-h-[760px]">
        ...
        <div className="absolute inset-0 z-10 flex flex-col justify-between p-7 text-white md:p-12">
          <div className="max-w-md">
            ...
            <h2 className="mt-4 font-body text-5xl font-semibold leading-[0.96] tracking-[-0.055em] md:text-7xl">Soko A01</h2>
      ...
      <div className="mt-28">
        <div className="mb-10 flex items-end justify-between gap-6">
          <div>
            ...
            <h3 className="mt-4 font-body text-4xl font-semibold leading-[1.02] tracking-[-0.045em] text-foreground md:text-6xl">In the field.</h3>
          </div>
            ...
            <figure key={story.title} className="group relative min-h-[450px] overflow-hidden rounded-[2rem] bg-[#26302b] md:min-h-[560px]">
              ...
              <figcaption className="absolute inset-x-0 bottom-0 z-10 flex items-end justify-between gap-6 p-7 text-white md:p-10">
                <div>
                  ...
                  <h4 className="mt-3 font-body text-3xl font-semibold tracking-[-0.04em] md:text-5xl">{story.title}</h4>
      ...
      <div className="mt-20 border-t border-border pt-10 text-center">
        ...
        <h3 className="mx-auto mt-5 max-w-3xl font-body text-4xl font-semibold leading-[1.02] tracking-[-0.045em] text-foreground md:text-6xl">One humanoid general hand. Many kinds of work. Less risk to people.</h3>
