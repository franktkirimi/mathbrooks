  ...
  return (
    <>
      <figure className="relative min-h-[680px] overflow-hidden rounded-[2.5rem] bg-[#101211] shadow-[0_32px_80px_hsl(var(--foreground)/0.14)] lg:min-h-[760px]">
        ...
        <div className="absolute inset-0 z-10 flex flex-col justify-between p-7 text-white md:p-12">
          <div className="max-w-md">
            ...
            <h1 className="mt-4 font-display text-5xl font-semibold leading-[0.96] tracking-[-0.055em] md:text-7xl">SOKO A01</h1>
            <p className="mt-4 max-w-sm text-sm font-semibold tracking-[0.02em] text-[#f5a170]">Sensory-Oriented Kinetic Operator</p>
      ...
      <div className="mt-20 border-t border-border pt-10 text-center">
        ...
        <p className="mt-6 text-base font-light text-muted-foreground">MathBrooks Things — Embodied intelligence for demanding operating environments.</p>
      </div>
    </>
  );
};
