...
const WhatsAppWidget = () => {
  return (
    <a
      ...
      className="fixed right-4 bottom-4 md:right-6 md:bottom-6 z-40 inline-flex items-center gap-2 rounded-full bg-green-500 px-4 py-3 text-white shadow-[0_18px_45px_rgba(34,197,94,0.35)] hover:bg-green-400 transition-colors duration-300"
    >
